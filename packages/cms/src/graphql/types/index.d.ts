namespace Graphql {
  ...
  interface Plugin extends Strapi.GenericPlugin {
    service<T = any>(
      name: 'extension' | 'content-api' | 'type-registry' | 'format',
    ): T;
  }

  type ResolverContext = ParameterizedContext<{
    user: UsersPermissions.UserEntity;
  }>;
  ...
  type MiddlewareFn = (
    ...
    source: any,
    args: any,
    context: Graphql.ResolverContext,
