...
export const afterCreateMembershipOrderItemLifeCycleHook: LifecycleHook =
  async (event: AfterLifecycleEvent) => {
    handleLogger(
      'info',
      'MembershipOrderItem afterCreateMembershipOrderItemLifeCycleHook',
    ...
    await updateOrderTotalOnNewOrderItemAdd('memberships')(
      event,
      currentOrder,
      currentItemData,
    );
