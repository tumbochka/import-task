...
export const afterCreateClassOrderItemLifeCycleHook: LifecycleHook = async (
  event: AfterLifecycleEvent,
) => {
  handleLogger(
    'info',
    'ClassOrderItem afterCreateClassOrderItemLifeCycleHook',
  ...
  await updateOrderTotalOnNewOrderItemAdd('classes')(
    event,
    currentOrder,
    currentItemData,
  );
